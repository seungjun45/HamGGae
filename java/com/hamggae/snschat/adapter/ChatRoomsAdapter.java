...
public class ChatRoomsAdapter extends RecyclerView.Adapter<ChatRoomsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public TextView name, message, timestamp, count, countryname, MemberCount;
        ...
        public ViewHolder(View view) {
            ...
            countryname = (TextView) view.findViewById(R.id.Onefragment_countryname);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.countryname.setText(chatRoom.getKOR_name());
        holder.MemberCount.setText(chatRoom.getMemberCount());
    }
